...
#define VG_DRAWING_BVI_drawStringOnCircleGradient CONCAT(VG_DRAWING_drawStringOnCircleGradient_, \
 ...
 */
DRAWING_Status VG_DRAWING_BVI_drawPath(MICROUI_GraphicsContext *gc, const jbyte *path, const jfloat *matrix,
                                       jint fillRule, jint blend, jint color);

/*
 * @brief Implementation of drawGradient over a BufferedVectorImage. See vg_drawing.h
 */
DRAWING_Status VG_DRAWING_BVI_drawGradient(MICROUI_GraphicsContext *gc, const jbyte *path, const jfloat *matrix,
