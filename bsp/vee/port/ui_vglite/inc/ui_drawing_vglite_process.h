 ...
 * @see vg_lite_draw()
 */
typedef DRAWING_Status (* UI_DRAWING_VGLITE_PROCESS_draw_path_t) (MICROUI_GraphicsContext *gc, vg_lite_path_t *path,
 ...
 */
typedef DRAWING_Status (* UI_DRAWING_VGLITE_PROCESS_blit_rect_t)(MICROUI_GraphicsContext *gc, vg_lite_buffer_t *source,
                                                                 uint32_t *rect, vg_lite_matrix_t *matrix,
                                                                 vg_lite_blend_t blend, vg_lite_color_t color,
 ...
 * @see vg_lite_clear()
 */
typedef DRAWING_Status (* UI_DRAWING_VGLITE_PROCESS_clear_t)(MICROUI_GraphicsContext *gc, vg_lite_rectangle_t *rect,
...
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                  MICROUI_GraphicsContext *gc, jint startX, jint startY, jint endX,
                                                  jint endY);
...
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                            MICROUI_GraphicsContext *gc, jint startX, jint startY,
                                                            jint endX, jint endY, jint thickness, DRAWING_Cap startCap,
                                                            DRAWING_Cap endCap);
...
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedCircleArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                                 ...
                                                                 jint thickness, DRAWING_Cap start, DRAWING_Cap end);
...
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawFlippedImage(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer,
                                                          MICROUI_GraphicsContext *gc, MICROUI_Image *img, jint regionX,
