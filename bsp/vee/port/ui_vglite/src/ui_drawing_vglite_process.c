 ...
 */
static DRAWING_Status __draw_ellipse_arc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc,
                                         int x, int y, int diameter_w, int diameter_h, float start_angle,
                                         float arc_angle, bool fill);
 ...
 * @return the drawing status.
 */
static DRAWING_Status __draw_ellipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, float x,
                                     float y, int diameter_out_w, int diameter_out_h, int diameter_in_w,
                                     int diameter_in_h);
 ...
 * @return the drawing status.
 */
static DRAWING_Status __fill_ellipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, float x,
                                     float y, int diameter_w, int diameter_h);
 ...
 * @return the drawing status.
 */
static DRAWING_Status __draw_line(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, int xs,
 ...
 * @return the drawing status.
 */
static DRAWING_Status __thick_line(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, int xs,
                                   int ys, int xe, int ye, int thickness, DRAWING_Cap start, DRAWING_Cap end);
...
static DRAWING_Status __draw_thick_shape_ellipse_arc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                     MICROUI_GraphicsContext *gc, int x, int y, int diameter_w,
                                                     int diameter_h, float start_angle_deg, float arc_angle,
                                                     int thickness, DRAWING_Cap start, DRAWING_Cap end);
...
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                  MICROUI_GraphicsContext *gc, jint x1, jint y1, jint x2, jint y2) {
	DRAWING_Status ret;
	...
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, 0, 0, gc->image.width, gc->image.height)) {
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawHorizontalLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                            MICROUI_GraphicsContext *gc, jint x1, jint x2, jint y) {
	DRAWING_Status ret;
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawVerticalLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                          MICROUI_GraphicsContext *gc, jint x, jint y1, jint y2) {
	DRAWING_Status ret;
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_fillRectangle(UI_DRAWING_VGLITE_PROCESS_clear_t drawer,
                                                       MICROUI_GraphicsContext *gc, jint x1, jint y1, jint x2,
                                                       jint y2) {
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawRoundedRectangle(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                              MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                              jint height, jint arc_width, jint arc_height) {
	...
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, x, y, x + width, y + height)) {
		...
		int path_offset = 0;
		path_offset = UI_DRAWING_VGLITE_PATH_compute_rounded_rectangle(&shape_vg_path, path_offset, x, y, width, height,
		                                                               l_arc_width, l_arc_height, false);

		path_offset = UI_DRAWING_VGLITE_PATH_compute_rounded_rectangle(&shape_vg_path, path_offset, x + 1, y + 1,
		                                                               width - 2, height - 2, l_arc_width - 1,
		                                                               l_arc_height - 1, true);
		...
		if (0 > path_offset) {
			...
			ret = (*drawer)(gc, &shape_vg_path, VG_LITE_FILL_EVEN_ODD, &matrix, VG_LITE_BLEND_SRC_OVER,
			                gc->foreground_color
			                );
		}
	} else {
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_fillRoundedRectangle(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                              MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                              jint height, jint arc_width, jint arc_height) {
	vg_lite_matrix_t matrix;
	DRAWING_Status ret;
	...
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, x, y, x + width, y + height)) {
		...
		shape_vg_path.path = &__shape_paths.rounded_rectangle[0];
		shape_vg_path.path_length = sizeof(__shape_paths.rounded_rectangle);
		int path_offset = UI_DRAWING_VGLITE_PATH_compute_rounded_rectangle(&shape_vg_path, 0, x, y, width, height,
		                                                                   l_arc_width, l_arc_height, true);
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawCircle(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                    MICROUI_GraphicsContext *gc, jint x, jint y, jint diameter) {
	DRAWING_Status ret;

	ret = __draw_ellipse(drawer, gc, x, y, diameter, diameter, diameter - 2, diameter - 2);

	return ret;
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawCircleArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                       MICROUI_GraphicsContext *gc, jint x, jint y, jint diameter,
	...
	if (MEJ_ABS(arc_angle) >= 360) {
		...
		ret = __draw_ellipse_arc(drawer, gc, x - 1, y - 1, diameter, diameter, start_angle, arc_angle, false);
	}
	return ret;
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_fillEllipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                     MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                     jint height) {
	DRAWING_Status ret;
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawEllipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                     MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                     jint height) {
	DRAWING_Status ret;
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_fillCircle(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                    MICROUI_GraphicsContext *gc, jint x, jint y, jint diameter) {
	DRAWING_Status ret;
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawEllipseArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                        MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                        jint height, jfloat start_angle, jfloat arc_angle) {
	DRAWING_Status ret;

	if (MEJ_ABS(arc_angle) >= 360) {
		ret = UI_DRAWING_VGLITE_PROCESS_drawEllipse(drawer, gc, x, y, width, height);
	} else {
		ret = __draw_ellipse_arc(drawer, gc, x - 1, y - 1, width, height, start_angle, arc_angle, false);
	}
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_fillCircleArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                       MICROUI_GraphicsContext *gc, jint x, jint y, jint diameter,
                                                       jfloat start_angle, jfloat arc_angle) {
	DRAWING_Status ret;
	...
	if (MEJ_ABS(arc_angle) >= 360) {
		...
		ret = __draw_ellipse_arc(drawer, gc, x, y, diameter, diameter, start_angle, arc_angle, true);
	}
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_fillEllipseArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                        MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                        jint height, jfloat start_angle, jfloat arc_angle) {
	DRAWING_Status ret;

	if (MEJ_ABS(arc_angle) >= 360) {
		ret = UI_DRAWING_VGLITE_PROCESS_fillEllipse(drawer, gc, x, y, width, height);
	} else {
		ret = __draw_ellipse_arc(drawer, gc, x, y, width, height, start_angle, arc_angle, true);
	}
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedPoint(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                             MICROUI_GraphicsContext *gc, jint x, jint y,
                                                             jint thickness) {
	float dx = x + 0.5f;
	float dy = y + 0.5f;
	float ft = thickness;
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                            MICROUI_GraphicsContext *gc, jint x1, jint y1, jint x2,
                                                            jint y2, jint thickness, DRAWING_Cap start,
                                                            DRAWING_Cap end) {
	return __thick_line(drawer, gc, x1, y1, x2, y2, thickness, start, end);
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedCircle(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                              MICROUI_GraphicsContext *gc, jint x, jint y,
	...
	return __draw_ellipse(drawer, gc, dx - ft, dy - ft, diameter_out, diameter_out, diameter_in, diameter_in);
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedCircleArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                                 MICROUI_GraphicsContext *gc, jint x, jint y,
                                                                 jint diameter, jfloat start_angle_deg,
                                                                 jfloat arc_angle, jint thickness, DRAWING_Cap start,
                                                                 DRAWING_Cap end) {
	return __draw_thick_shape_ellipse_arc(drawer, gc, x, y, diameter, diameter, start_angle_deg, arc_angle, thickness,
	                                      start, end);
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickFadedEllipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                               MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
	...
	return __draw_ellipse(drawer, gc, dx - ft, dy - ft, diameter_out_w, diameter_out_h, diameter_in_w, diameter_in_h);
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickLine(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                       MICROUI_GraphicsContext *gc, jint x1, jint y1, jint x2, jint y2,
                                                       jint thickness) {
	DRAWING_Status ret;

	ret = __thick_line(drawer, gc, x1, y1, x2, y2, thickness, DRAWING_ENDOFLINE_NONE, DRAWING_ENDOFLINE_NONE);
	return ret;
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickCircle(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                         MICROUI_GraphicsContext *gc, jint x, jint y, jint diameter,
                                                         jint thickness) {
	int diameter_out;
	int diameter_in;
	...
	ret = __draw_ellipse(drawer, gc, dx - ft, dy - ft, diameter_out, diameter_out, diameter_in, diameter_in);

	return ret;
}

DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickEllipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                          MICROUI_GraphicsContext *gc, jint x, jint y, jint width,
                                                          jint height, jint thickness) {
	int diameter_out_w;
	int diameter_out_h;
	...
	ret = __draw_ellipse(drawer, gc, dx - ft, dy - ft, diameter_out_w, diameter_out_h, diameter_in_w, diameter_in_h);

	return ret;
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawThickCircleArc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
                                                            MICROUI_GraphicsContext *gc, jint x, jint y, jint diameter,
                                                            jfloat start_angle_deg, jfloat arc_angle, jint thickness) {
	DRAWING_Status ret;

	ret = __draw_thick_shape_ellipse_arc(drawer, gc, x, y, diameter, diameter, start_angle_deg, arc_angle, thickness,
	                                     DRAWING_ENDOFLINE_NONE, DRAWING_ENDOFLINE_NONE);
	return ret;
}

// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawFlippedImage(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer,
                                                          MICROUI_GraphicsContext *gc, MICROUI_Image *img,
                                                          jint region_x, jint region_y, jint width, jint height, jint x,
	...
	*is_gpu_compatible = UI_VGLITE_configure_source(&source_buffer, img);
	...
	if (*is_gpu_compatible) {
		...
		// Check if there is something to draw and clip drawing limits
		if ((dest_width > 0u) && (dest_height > 0u) && UI_VGLITE_enable_vg_lite_scissor_region(gc, x, y,
		                                                                                       (x + dest_width - 1),
		                                                                                       (y + dest_height - 1))) {
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawRotatedImageNearestNeighbor(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer,
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawRotatedImageBilinear(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer,
                                                                  MICROUI_GraphicsContext *gc, MICROUI_Image *img,
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawScaledImageNearestNeighbor(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer,
                                                                        MICROUI_GraphicsContext *gc, MICROUI_Image *img,
...
// See the header file for the function documentation
DRAWING_Status UI_DRAWING_VGLITE_PROCESS_drawScaledImageBilinear(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer,
                                                                 MICROUI_GraphicsContext *gc, MICROUI_Image *img,
                                                                 jint x, jint y, jfloat factorX, jfloat factorY,
                                                                 jint alpha, bool *is_gpu_compatible) {
	DRAWING_Status ret;
...
// See the section 'Internal function definitions' for the function documentation
static DRAWING_Status __draw_ellipse_arc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc,
                                         int x, int y, int diameter_w, int diameter_h, float start_angle_deg,
                                         float arc_angle_deg, bool fill) {
	vg_lite_matrix_t matrix;
	DRAWING_Status ret;
	...
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, x - 1, y - 1, x + diameter_w, y + diameter_h)) {
		...
		int path_offset = UI_DRAWING_VGLITE_PATH_compute_ellipse_arc(&shape_vg_path, (int)radius_out_w,
		                                                             (int)radius_out_h, (int)radius_in_w,
		                                                             (int)radius_in_h, 90.f - start_angle_deg,
		                                                             -arc_angle_deg, fill);
...
static DRAWING_Status __draw_ellipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, float x,
	...
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, (int)(x - 1.0f), (int)(y - 1.0f), (int)(x + (float)diameter_out_w),
		...
		int path_offset = UI_DRAWING_VGLITE_PATH_compute_ellipse(&shape_vg_path, 0, (int)radius_w, (int)radius_h,
		                                                         false);
		...
		path_offset = UI_DRAWING_VGLITE_PATH_compute_ellipse(&shape_vg_path, path_offset, (int)radius_w, (int)radius_h,
		                                                     true);
...
static DRAWING_Status __fill_ellipse(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, float x,
	...
	// Check if there is something to draw and clip drawing limits
	// +/- 1: consider 1 pixel of antialiasing
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, (int)(x - 1.0f), (int)(y - 1.0f), (int)(x + (float)diameter_w),
		...
		// Draw the point with the GPU
		ret = (*drawer)(gc, &shape_vg_path, VG_LITE_FILL_NON_ZERO, &matrix, VG_LITE_BLEND_SRC_OVER,
		                gc->foreground_color);
	} else {
		ret = DRAWING_DONE;
	}
...
static DRAWING_Status __draw_line(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, int xs,
	...
	return (*drawer)(gc, &shape_vg_path, VG_LITE_FILL_NON_ZERO, &matrix, VG_LITE_BLEND_SRC_OVER, gc->foreground_color);
}
...
static DRAWING_Status __thick_line(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer, MICROUI_GraphicsContext *gc, int xs,
	...
	// Check if there is something to draw and clip drawing limits
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, min_x - (thickness / 2), min_y - (thickness / 2),
	                                            max_x + (thickness / 2), max_y + (thickness / 2))) {
		// Translate to the line starting point
		vg_lite_identity(&matrix);
		vg_lite_translate(xs, ys, &matrix);
		...
		(void)UI_DRAWING_VGLITE_PATH_compute_thick_shape_line(&shape_vg_path, (int)(DRAWING_SCALE_FACTOR * (xe - xs)),
		                                                      (int)(DRAWING_SCALE_FACTOR * (ye - ys)),
		                                                      (int)(DRAWING_SCALE_FACTOR * thickness), caps, &matrix);
...
static DRAWING_Status __draw_thick_shape_ellipse_arc(UI_DRAWING_VGLITE_PROCESS_draw_path_t drawer,
	...
	// Check if there is something to draw and clip drawing limits
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, x - thickness, y - thickness, x + diameter_w + (2 * thickness) - 1,
		...
		(void)UI_DRAWING_VGLITE_PATH_compute_thick_shape_ellipse_arc(&shape_vg_path,
		                                                             (int)(DRAWING_SCALE_FACTOR * diameter_w),
		                                                             (int)(DRAWING_SCALE_FACTOR * diameter_h),
		                                                             (int)(DRAWING_SCALE_FACTOR * thickness), 0,
		                                                             arc_angle, caps);
...
static DRAWING_Status __scale_image(UI_DRAWING_VGLITE_PROCESS_blit_rect_t drawer, MICROUI_GraphicsContext *gc,
	...
	// Check if there is something to draw and clip drawing limits
	if (UI_VGLITE_enable_vg_lite_scissor_region(gc, x, y, (int)(x + (factorX * img->width)),
