...
typedef int (*LLSEC_SIG_verify)(LLSEC_SIG_algorithm *algorithm, uint8_t *signature, int32_t signature_length,
                                LLSEC_pub_key *pub_key, uint8_t *digest, int32_t digest_length);
typedef int (*LLSEC_SIG_sign)(LLSEC_SIG_algorithm *algorithm, uint8_t *signature, int32_t *signature_length,
                              LLSEC_priv_key *priv_key, uint8_t *digest, int32_t digest_length);
...
static int LLSEC_SIG_mbedtls_verify(LLSEC_SIG_algorithm *algorithm, uint8_t *signature, int32_t signature_length,
                                    LLSEC_pub_key *pub_key, uint8_t *digest, int32_t digest_length);
static int LLSEC_SIG_mbedtls_sign(LLSEC_SIG_algorithm *algorithm, uint8_t *signature, int32_t *signature_length,
                                  LLSEC_priv_key *priv_key, uint8_t *digest, int32_t digest_length);

static int LLSEC_SIG_mbedtls_ec_verify(LLSEC_SIG_algorithm *algorithm, uint8_t *signature, int32_t signature_length,
                                       LLSEC_pub_key *pub_key, uint8_t *digest, int32_t digest_length);
...
uint8_t LLSEC_SIG_IMPL_verify(int32_t algorithm_id, uint8_t *signature, int32_t signature_length, int32_t public_key_id,
	...
	int rc = algorithm->verify(algorithm, signature, signature_length, (LLSEC_pub_key *)public_key_id, digest,
	                           digest_length);
...
int32_t LLSEC_SIG_IMPL_sign(int32_t algorithm_id, uint8_t *signature, int32_t signature_length, int32_t private_key_id,
	...
	LLSEC_SIG_algorithm *algorithm = (LLSEC_SIG_algorithm *)algorithm_id;
	int rc = algorithm->sign(algorithm, signature, &signature_length, (LLSEC_priv_key *)private_key_id, digest,
	                         digest_length);
